# Contributing to StrenDCAT-Biocatalysis

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
StrenDCAT-Biocatalysis. These guidelines are not strict rules.
...
The StrenDCAT-Biocatalysis team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the StrenDCAT-Biocatalysis technical leads
...
[issues]: https://github.com/mvoelken-hub/StrenDCAT-Biocatalysis/issues/
[pulls]: https://github.com/mvoelken-hub/StrenDCAT-Biocatalysis/pulls/
