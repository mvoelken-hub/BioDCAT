...
# Generation date: 2026-05-13T11:44:21
...
slots.vial_size_unit = Slot(uri=STRENDCAT_BIOCATALYSIS.vial_size_unit, name="vial_size_unit", curie=STRENDCAT_BIOCATALYSIS.curie('vial_size_unit'),
                   model_uri=STRENDCAT_BIOCATALYSIS.vial_size_unit, domain=None, range=Optional[Union[str, list[str]]])

slots.vial_material = Slot(uri=STRENDCAT_BIOCATALYSIS.vial_material, name="vial_material", curie=STRENDCAT_BIOCATALYSIS.curie('vial_material'),
                   model_uri=STRENDCAT_BIOCATALYSIS.vial_material, domain=None, range=Optional[Union[str, list[str]]])

slots.closure_type = Slot(uri=STRENDCAT_BIOCATALYSIS.closure_type, name="closure_type", curie=STRENDCAT_BIOCATALYSIS.curie('closure_type'),
                   model_uri=STRENDCAT_BIOCATALYSIS.closure_type, domain=None, range=Optional[Union[str, list[str]]])

slots.plate_type = Slot(uri=STRENDCAT_BIOCATALYSIS.plate_type, name="plate_type", curie=STRENDCAT_BIOCATALYSIS.curie('plate_type'),
                   model_uri=STRENDCAT_BIOCATALYSIS.plate_type, domain=None, range=Optional[Union[str, list[str]]])

slots.plate_material = Slot(uri=STRENDCAT_BIOCATALYSIS.plate_material, name="plate_material", curie=STRENDCAT_BIOCATALYSIS.curie('plate_material'),
                   model_uri=STRENDCAT_BIOCATALYSIS.plate_material, domain=None, range=Optional[Union[str, list[str]]])

slots.number_of_wells = Slot(uri=STRENDCAT_BIOCATALYSIS.number_of_wells, name="number_of_wells", curie=STRENDCAT_BIOCATALYSIS.curie('number_of_wells'),
                   model_uri=STRENDCAT_BIOCATALYSIS.number_of_wells, domain=None, range=Optional[int])

slots.well_shape = Slot(uri=STRENDCAT_BIOCATALYSIS.well_shape, name="well_shape", curie=STRENDCAT_BIOCATALYSIS.curie('well_shape'),
                   model_uri=STRENDCAT_BIOCATALYSIS.well_shape, domain=None, range=Optional[Union[str, list[str]]])

slots.well_volume = Slot(uri=STRENDCAT_BIOCATALYSIS.well_volume, name="well_volume", curie=STRENDCAT_BIOCATALYSIS.curie('well_volume'),
                   model_uri=STRENDCAT_BIOCATALYSIS.well_volume, domain=None, range=Optional[Union[Union[dict, Volume], list[Union[dict, Volume]]]])

slots.well_arrangement = Slot(uri=STRENDCAT_BIOCATALYSIS.well_arrangement, name="well_arrangement", curie=STRENDCAT_BIOCATALYSIS.curie('well_arrangement'),
                   model_uri=STRENDCAT_BIOCATALYSIS.well_arrangement, domain=None, range=Optional[Union[str, list[str]]])

slots.sealing_method = Slot(uri=STRENDCAT_BIOCATALYSIS.sealing_method, name="sealing_method", curie=STRENDCAT_BIOCATALYSIS.curie('sealing_method'),
                   model_uri=STRENDCAT_BIOCATALYSIS.sealing_method, domain=None, range=Optional[Union[str, list[str]]])

slots.sealing_material = Slot(uri=STRENDCAT_BIOCATALYSIS.sealing_material, name="sealing_material", curie=STRENDCAT_BIOCATALYSIS.curie('sealing_material'),
...
slots.reactor_material = Slot(uri=STRENDCAT_BIOCATALYSIS.reactor_material, name="reactor_material", curie=STRENDCAT_BIOCATALYSIS.curie('reactor_material'),
                   model_uri=STRENDCAT_BIOCATALYSIS.reactor_material, domain=None, range=Optional[Union[str, list[str]]])

slots.bottom_type = Slot(uri=STRENDCAT_BIOCATALYSIS.bottom_type, name="bottom_type", curie=STRENDCAT_BIOCATALYSIS.curie('bottom_type'),
                   model_uri=STRENDCAT_BIOCATALYSIS.bottom_type, domain=None, range=Optional[Union[str, list[str]]])

slots.reactor_type_description = Slot(uri=STRENDCAT_BIOCATALYSIS.reactor_type_description, name="reactor_type_description", curie=STRENDCAT_BIOCATALYSIS.curie('reactor_type_description'),
                   model_uri=STRENDCAT_BIOCATALYSIS.reactor_type_description, domain=None, range=Optional[Union[str, list[str]]])

slots.tubing = Slot(uri=STRENDCAT_BIOCATALYSIS.tubing, name="tubing", curie=STRENDCAT_BIOCATALYSIS.curie('tubing'),
                   model_uri=STRENDCAT_BIOCATALYSIS.tubing, domain=None, range=Optional[Union[str, list[str]]])

slots.has_flow_rate = Slot(uri=STRENDCAT_BIOCATALYSIS.has_flow_rate, name="has_flow_rate", curie=STRENDCAT_BIOCATALYSIS.curie('has_flow_rate'),
...
slots.has_catalyst_localisation = Slot(uri=STRENDCAT_BIOCATALYSIS.has_catalyst_localisation, name="has_catalyst_localisation", curie=STRENDCAT_BIOCATALYSIS.curie('has_catalyst_localisation'),
                   model_uri=STRENDCAT_BIOCATALYSIS.has_catalyst_localisation, domain=None, range=Optional[Union[str, list[str]]])

slots.has_residence_time = Slot(uri=STRENDCAT_BIOCATALYSIS.has_residence_time, name="has_residence_time", curie=STRENDCAT_BIOCATALYSIS.curie('has_residence_time'),
...
slots.has_reynolds_number = Slot(uri=STRENDCAT_BIOCATALYSIS.has_reynolds_number, name="has_reynolds_number", curie=STRENDCAT_BIOCATALYSIS.curie('has_reynolds_number'),
                   model_uri=STRENDCAT_BIOCATALYSIS.has_reynolds_number, domain=None, range=Optional[Union[str, list[str]]])

slots.has_passive_mixing = Slot(uri=STRENDCAT_BIOCATALYSIS.has_passive_mixing, name="has_passive_mixing", curie=STRENDCAT_BIOCATALYSIS.curie('has_passive_mixing'),
                   model_uri=STRENDCAT_BIOCATALYSIS.has_passive_mixing, domain=None, range=Optional[Union[str, list[str]]])

slots.has_active_mixer = Slot(uri=STRENDCAT_BIOCATALYSIS.has_active_mixer, name="has_active_mixer", curie=STRENDCAT_BIOCATALYSIS.curie('has_active_mixer'),
                   model_uri=STRENDCAT_BIOCATALYSIS.has_active_mixer, domain=None, range=Optional[Union[str, list[str]]])

slots.has_pulsing_description = Slot(uri=STRENDCAT_BIOCATALYSIS.has_pulsing_description, name="has_pulsing_description", curie=STRENDCAT_BIOCATALYSIS.curie('has_pulsing_description'),
                   model_uri=STRENDCAT_BIOCATALYSIS.has_pulsing_description, domain=None, range=Optional[Union[str, list[str]]])

slots.stirring_type = Slot(uri=STRENDCAT_BIOCATALYSIS.stirring_type, name="stirring_type", curie=STRENDCAT_BIOCATALYSIS.curie('stirring_type'),
                   model_uri=STRENDCAT_BIOCATALYSIS.stirring_type, domain=None, range=Optional[Union[str, list[str]]])

slots.stirrer_material = Slot(uri=STRENDCAT_BIOCATALYSIS.stirrer_material, name="stirrer_material", curie=STRENDCAT_BIOCATALYSIS.curie('stirrer_material'),
                   model_uri=STRENDCAT_BIOCATALYSIS.stirrer_material, domain=None, range=Optional[Union[str, list[str]]])

slots.number_of_stirrers = Slot(uri=STRENDCAT_BIOCATALYSIS.number_of_stirrers, name="number_of_stirrers", curie=STRENDCAT_BIOCATALYSIS.curie('number_of_stirrers'),
                   model_uri=STRENDCAT_BIOCATALYSIS.number_of_stirrers, domain=None, range=Optional[int])

slots.distance_between_stirrers = Slot(uri=STRENDCAT_BIOCATALYSIS.distance_between_stirrers, name="distance_between_stirrers", curie=STRENDCAT_BIOCATALYSIS.curie('distance_between_stirrers'),
...
slots.blade_pitch_angle = Slot(uri=STRENDCAT_BIOCATALYSIS.blade_pitch_angle, name="blade_pitch_angle", curie=STRENDCAT_BIOCATALYSIS.curie('blade_pitch_angle'),
...
slots.number_of_blades = Slot(uri=STRENDCAT_BIOCATALYSIS.number_of_blades, name="number_of_blades", curie=STRENDCAT_BIOCATALYSIS.curie('number_of_blades'),
                   model_uri=STRENDCAT_BIOCATALYSIS.number_of_blades, domain=None, range=Optional[int])

slots.blade_size = Slot(uri=STRENDCAT_BIOCATALYSIS.blade_size, name="blade_size", curie=STRENDCAT_BIOCATALYSIS.curie('blade_size'),
...
slots.stirrer_geometry = Slot(uri=STRENDCAT_BIOCATALYSIS.stirrer_geometry, name="stirrer_geometry", curie=STRENDCAT_BIOCATALYSIS.curie('stirrer_geometry'),
                   model_uri=STRENDCAT_BIOCATALYSIS.stirrer_geometry, domain=None, range=Optional[Union[str, list[str]]])

slots.stirrer_speed = Slot(uri=STRENDCAT_BIOCATALYSIS.stirrer_speed, name="stirrer_speed", curie=STRENDCAT_BIOCATALYSIS.curie('stirrer_speed'),
...
slots.height_above_vessel_base = Slot(uri=STRENDCAT_BIOCATALYSIS.height_above_vessel_base, name="height_above_vessel_base", curie=STRENDCAT_BIOCATALYSIS.curie('height_above_vessel_base'),
...
slots.power_per_volume_input = Slot(uri=STRENDCAT_BIOCATALYSIS.power_per_volume_input, name="power_per_volume_input", curie=STRENDCAT_BIOCATALYSIS.curie('power_per_volume_input'),
...
slots.stir_bar_size = Slot(uri=STRENDCAT_BIOCATALYSIS.stir_bar_size, name="stir_bar_size", curie=STRENDCAT_BIOCATALYSIS.curie('stir_bar_size'),
...
slots.stir_bar_shape = Slot(uri=STRENDCAT_BIOCATALYSIS.stir_bar_shape, name="stir_bar_shape", curie=STRENDCAT_BIOCATALYSIS.curie('stir_bar_shape'),
                   model_uri=STRENDCAT_BIOCATALYSIS.stir_bar_shape, domain=None, range=Optional[Union[str, list[str]]])

slots.shaking_type = Slot(uri=STRENDCAT_BIOCATALYSIS.shaking_type, name="shaking_type", curie=STRENDCAT_BIOCATALYSIS.curie('shaking_type'),
                   model_uri=STRENDCAT_BIOCATALYSIS.shaking_type, domain=None, range=Optional[Union[str, list[str]]])

slots.deflection = Slot(uri=STRENDCAT_BIOCATALYSIS.deflection, name="deflection", curie=STRENDCAT_BIOCATALYSIS.curie('deflection'),
...
slots.shaking_speed = Slot(uri=STRENDCAT_BIOCATALYSIS.shaking_speed, name="shaking_speed", curie=STRENDCAT_BIOCATALYSIS.curie('shaking_speed'),
...
slots.shaking_position = Slot(uri=STRENDCAT_BIOCATALYSIS.shaking_position, name="shaking_position", curie=STRENDCAT_BIOCATALYSIS.curie('shaking_position'),
...
slots.gas_supply_method = Slot(uri=STRENDCAT_BIOCATALYSIS.gas_supply_method, name="gas_supply_method", curie=STRENDCAT_BIOCATALYSIS.curie('gas_supply_method'),
                   model_uri=STRENDCAT_BIOCATALYSIS.gas_supply_method, domain=None, range=Optional[Union[str, list[str]]])

slots.temperature_control_method = Slot(uri=STRENDCAT_BIOCATALYSIS.temperature_control_method, name="temperature_control_method", curie=STRENDCAT_BIOCATALYSIS.curie('temperature_control_method'),
                   model_uri=STRENDCAT_BIOCATALYSIS.temperature_control_method, domain=None, range=Optional[Union[str, list[str]]])

slots.has_gas_type = Slot(uri=STRENDCAT_BIOCATALYSIS.has_gas_type, name="has_gas_type", curie=STRENDCAT_BIOCATALYSIS.curie('has_gas_type'),
